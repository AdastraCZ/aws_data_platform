...
# processing
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "data_lake_raw", table_name = "co2_emissions", transformation_ctx = "datasource0")
...
# creating tables
df_dropfields1.createOrReplaceTempView('wb_co2_emissions')
...
df_sql.write \
  ...
  .format("parquet") \
  .partitionBy("year") \
  .save("s3://adastracz-demo-datalake-curated/wb_co2_emissions/")
