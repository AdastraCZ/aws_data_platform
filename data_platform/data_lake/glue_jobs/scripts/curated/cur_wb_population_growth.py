...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "data_lake_raw", table_name = "population_growth", transformation_ctx = "datasource0")
...
# creating tables
df_dropfields1.createOrReplaceTempView('population_growth')
...
df_sql.write \
  ...
  .format("parquet") \
  .partitionBy("year") \
  .save("s3://adastracz-demo-datalake-curated/wb_population_growth/")
