...
# processing
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "data_lake_raw", table_name = "gdp_per_capita", transformation_ctx = "datasource0")
...
# creating tables
df_dropfields1.createOrReplaceTempView('gdp_per_capita')
...
df_sql.write \
  ...
  .format("parquet") \
  .partitionBy("year") \
  .save("s3://adastracz-demo-datalake-curated/wb_gdp_per_capita/")
