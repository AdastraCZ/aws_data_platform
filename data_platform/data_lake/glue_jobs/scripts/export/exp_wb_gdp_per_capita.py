...
# processing
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "data_lake_curated", table_name = "wb_gdp_per_capita", transformation_ctx = "datasource0")
...
# creating tables
df_dropfields1.createOrReplaceTempView('wb_gdp_per_capita')
...
datasink4 = glueContext.write_dynamic_frame.from_jdbc_conf(
    ...
    connection_options={"dbtable": 'dwh_landing.wb_gdp_per_capita', "database": "postgres"},
